module Jsons
  class MorningForm
    ...
    def call(user_id:, team_id:)
      ...
      blocks << Input.call(label_text: '1. Jakie zadania na dziś planujesz oraz jak oceniasz czas ich wykonania?',
                           value_id: 'first_input')
      blocks << Input.call(label_text: '2. Jakie widzisz zagrożenia i blokery w powyższej liście?',
                           value_id: 'second_input')
      blocks << Input.call(label_text: '3. Czy w którymś z powyższych tematów chciałbyś otrzymać pomoc?',
                           value_id: 'third_input')
      blocks << Input.call(
